...
import {createAddress, createSchnorrAddress, createMultiSignAddress } from "../../bip32";
...
describe('btc unit test case', () => {
    ...
    test('createAddress by p2sh maninet', () => {
        const mnemonic = "around dumb spend sample oil crane plug embrace outdoor panel rhythm salon";
        const seed = bip39.mnemonicToSeedSync(mnemonic, "")
        const param = {
            seedHex: seed.toString("hex"),
    ...
    test('createAddress by p2tr maninet', () => {
        ...
        console.log(account.privateKey);
        console.log(account.publicKey);
        assert.strictEqual(account.address, 'bc1pprlal9nlfnwurget6pzphvclt3gt7rm77qxfgja6s0k7pavau3nscymnhl');
        assert.strictEqual(account.privateKey, '0eae66136c821af783512a7708f6335dbdbd73bdb90cab982390588a88327de7');
        assert.strictEqual(account.publicKey, '02f028954c26c689e4d452dcbbd8ed41cdaf494d172dc6ff7761349c6d44738494');
    });
